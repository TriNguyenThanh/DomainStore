...
public class testCustomerDAO {
    public static void main(String[] args) {
        ...
        // Thêm khách hàng mới
//        Customer newCustomer = new Customer("KH009", "Trịnh Trần Phương Tuấn", Date.valueOf("1997-03-03"), "082265718564", "Bến Tre", "ttpt1997@gmail.com", "0327876533", "password123", "", Role.user);
